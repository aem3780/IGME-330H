...
function setupCanvas(canvasElement,analyserNodeRef){
	...
	gradient = utils.getLinearGradient(ctx,0,0,0,canvasHeight,[{percent:0,color:"purple"},{percent:.25,color:"blue"},{percent:.5,color:"green"},{percent:.75,color:"blue"},{percent:1,color:"purple"}]);
