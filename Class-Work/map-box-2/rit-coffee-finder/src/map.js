...
function addMarker2(coord, name){
  let coordinates = Object.values(coord);
  let el = document.createElement('div');
  //el.className = className;
...
function addMarkersToMap()
{
  ...
  for (const { geometry, properties } of geojson.features) {
    addMarker(geometry.coordinates, properties.title, properties.description, 'marker');
  }
}
...
export {initMap,loadMarkers,addMarkersToMap, flyTo, setZoomLevel, setPitchAndBearing, addMarker, addMarker2};